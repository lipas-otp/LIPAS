...
from lipas import SideEffectClass as RootSideEffectClass
...
def test_side_effect_class_is_available_from_the_short_root_import():
    assert RootSideEffectClass.READ_ONLY is SideEffectClass.READ_ONLY
...
def test_tool_accepts_explicit_side_effect_string():
    @tool(side_effect="read_only")
    def lookup(key: str) -> str:
        """Look up a key."""
        return key

    assert lookup.side_effect is SideEffectClass.READ_ONLY
